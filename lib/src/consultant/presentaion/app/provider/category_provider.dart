...
final interestConsultantProvider = StateNotifierProvider<
    InterestConsultantNotifier, AsyncValue<List<CategoryEntity>>>(
  (ref) {
    final useCase = ref.watch(getInterestUseCaseProvider);
    return InterestConsultantNotifier(useCase);
  },
);
